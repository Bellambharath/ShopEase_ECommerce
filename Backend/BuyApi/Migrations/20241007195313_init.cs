    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "SHOPEASE200", true, "Flat $200 off on minimum purchase of $599 and Free shipping." },
                    { 2, "SUMMERSALE", false, "Flat 25% off on summer collection." },
                    { 3, "FREESHIP", true, "Free shipping on orders over $499." },
                    { 4, "SAVE100", true, "Flat $100 off on your first purchase (min purchase of $299)." },
