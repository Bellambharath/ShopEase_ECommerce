...
namespace BuyApi.Controllers
{
    ...
    public class BuysController : ControllerBase
    {
        ...
        {
            // Order ID Generation Using GUID
            ...
            // Get the system's local timezone and convert UTC time to the local time
            DateTime currentTimeUtc = DateTime.UtcNow;
            TimeZoneInfo localTimeZone = TimeZoneInfo.Local;
            DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(currentTimeUtc, localTimeZone);

            // Set the order times based on the converted local time
            buy.OrderPlacedTime = localTime;
            buy.StatusTime = localTime;
