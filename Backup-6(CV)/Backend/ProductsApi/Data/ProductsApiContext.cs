        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Products>().HasData(
                new Products
                {
                    ...
                    ProductName = "Apple AirPods (3rd Generation) Wireless Ear Buds, Bluetooth Headphones, Personalized Spatial Audio, Sweat and Water Resistant, Lightning Charging Case Included, Up to 30 Hours of Battery Life",
                    ProductPrice = 129.99,
                    Noofstocks = 19,
                    ProductRating = 1,
                ...
                new Products
                {
                    ...
                    ProductDescription = "Dear reader, I hope this book feels like a warm hug to you. I wrote this book for the ones who feel everything too deeply. You’re right, I wrote this book for you. This book was meant to find you if you’ve ever loved someone who didn’t love you back, if you’ve ever over-invested in the wrong people or if you have a hard time letting go. I Don’t Love You Anymore is a book that’ll feel like home to you. I promise it’ll hold you gently on your worst days.",
                ...
                new Products
                {
                    ...
                    ProductDescription = "Military Sport Design: Fashionable sporty dial design, military style outlook. Large Dial (acrylic crystal glass window, case diameter high-quality watch band, Reinforced resin band design is more ergonomic, comfortable to wear. Dial diameter is 2 inch / 50mm).",
                    ProductName = "KXAITO Men's Watches Sports Outdoor Waterproof Military Watch Date Multi Function Tactics LED Alarm Stopwatch",
                    ProductPrice = 21.99,
                    Noofstocks = 11,
                    ProductRating = 0,
                ...
                new Products
                {
                    ...
                    ProductDescription = "PURE FRAGRANCE POWDERY TOBACCO: Features the unique scent of tobacco leaves, highlighted by sweet honey and fruity notes with a touch of ginger. The rich base includes vanilla, tonka bean, dry fruit, and cacao for added depth.",
                    ProductName = "Dossier - Powdery Tobacco - Eau de Parfum - Inspired by T.Ford Tobacco Vanille - Perfume Luxury",
                    ProductPrice = 39,
                    Noofstocks = 7,
                    ProductRating = 0,
                ...
                new Products
                {
                    ...
                    ProductName = "Citizen Diamond Maleficent Sleeping Beauty Womens Diamond Accent Black Stainless Steel Bracelet Watch Em0595-51w",
                    ProductPrice = 327.85,
                    Noofstocks = 9,
                    ProductRating = 4,
                ...
                new Products
                {
                    ...
                    ProductDescription = "This vibrant and festive glitter gel is designed to enhance your beauty for any celebration or event. Made in USA, this hypoallergenic formula is easy to apply and remove.",
                    ProductName = "MEICOLY USA Flag Pride Face Body Glitter",
                    ProductPrice = 8.98,
                    Noofstocks = 10,
                    ProductRating = 0,
                    Imageurl = "https://m.media-amazon.com/images/I/81lA6H0sVkL.__AC_SX300_SY300_QL70_FMwebp_.jpg",
                    SellerName = "Go Ho"
                }
            );
        }
